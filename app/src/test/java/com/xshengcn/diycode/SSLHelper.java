...
public class SSLHelper {
    ...
    public InputStream trustedCertificatesInputStream() {
        // PEM files for root certificates of Comodo and Entrust.
        // These two CAs are sufficient to view
        // https://publicobject.com (Comodo) and https://squareup.com (Entrust). But they aren't
        // sufficient to connect to most HTTPS sites including
        // https://godaddy.com and https://visa.com.
        // Typically developers will need to get a PEM file
        // from their organization's TLS administrator.
