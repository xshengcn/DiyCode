...
public class ProjectPresenter extends BasePresenter<IProjectView> {
  ...
  @Inject public ProjectPresenter(DataManager dataManager) {
    this.dataManager = dataManager;
  }

  @Override public void onAttach(IProjectView view) {
    super.onAttach(view);
  }
  ...
  public void loadTopics(boolean clean) {
    ...
    Disposable disposable = dataManager.getProjects(offset)
