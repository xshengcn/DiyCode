...
public class NewsDetailActivity extends BaseActivity implements INewsDetailView {
  ...
  private static final String EXTRA_NEWS = "NewsDetailActivity.news";
  @BindView(R.id.toolbar) Toolbar toolbar;
  @BindView(R.id.appbar_layout) AppBarLayout appbarLayout;
  @BindView(R.id.recycler_View) RecyclerView recyclerView;

  @Inject NewsDetailPresenter presenter;
  @Inject NewsDetailAdapter adapter;
  ...
  @Override protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    if (savedInstanceState == null) news = getIntent().getParcelableExtra(EXTRA_NEWS);
  ...
  @Override public int getNewsId() {
    return news.id;
  }

  @Override public void showReplies(List<NewsReply> replies) {
