...
public class UserTopicActivity extends BaseActivity implements IUserTopicView, LoadMoreHandler {
  ...
  @Override protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    if (prefs.getUser() != null && TextUtils.equals(userLogin, prefs.getUser().login)) {
      toolbar.setTitle(myTopics);
    } else {
      toolbar.setTitle(String.format(userTopics, userLogin));
    }
