...
import com.xshengcn.diycode.ui.usertopic.UserTopicPresenter;
import com.xshengcn.diycode.widget.itemdecoration.OffsetDecoration;
import java.util.List;
import javax.inject.Inject;

public class UserFavoriteActivity extends BaseActivity implements IUserFavoriteView {
  ...
  public static void start(Activity activity) {
    activity.startActivity(new Intent(activity, UserFavoriteActivity.class));
  }
